...
class Enrollment(models.Model):
    ...
    transaction = models.OneToOneField(Transaction, on_delete=models.CASCADE, related_name='enrollment', unique=True)

    class Meta:
        unique_together = ('user', 'course')  # Ensure unique enrollment per user and course
